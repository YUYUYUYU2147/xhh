import { yaml, mhy, api, pluginPriority, makeForwardMsg } from '#xhh';
import fs from 'fs';
import NoteUser from '../../genshin/model/mys/NoteUser.js';
import puppeteer from '../../../lib/puppeteer/puppeteer.js';
import moment from 'moment';
import { getCurrentAbyssInfoByEvent, formatCurrentAbyssInfo, getBh3BossCodex } from '../system/bh3_abyss_boss.js';
...
async abyss(e) {
  ...
  async abyssBoss(e) {
    ...
    const abyssText = `${formatCurrentAbyssInfo(info)}\n\n可发送 #崩三深渊攻略 查看详细作业图。`;
    ...
    const extra = codex === false ? `\n\n（图鉴暂未收录「${info.boss}」，可发 #崩三怪物 ${info.boss}图鉴 手动查）` : '';
    return sendMsg(e, abyssText + extra);
  }
